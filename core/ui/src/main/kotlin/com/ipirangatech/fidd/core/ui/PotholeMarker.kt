...
object PotholeMarker {
    ...
    private const val ASPHALT_PATH = "M22.30,12.00C22.24,13.72 21.59,15.53 20.75,17.05C19.91,18.57 18.71,20.23 17.25,21.09" +
    ...
    private const val CRATER_PATH = "M19.15,13.45C18.87,14.61 18.05,15.71 17.25,16.63C16.45,17.56 15.46,18.63 14.35,19.02" +
    ...
    fun severityColor(severity: Float): Int = when {
    ...
    fun bitmap(context: Context, craterColor: Int, sizeDp: Float = 30f): Bitmap = synchronized(cache) {
        cache.getOrPut(craterColor to sizeDp) { draw(context, craterColor, sizeDp) }
    }

    private fun draw(context: Context, craterColor: Int, sizeDp: Float): Bitmap {
