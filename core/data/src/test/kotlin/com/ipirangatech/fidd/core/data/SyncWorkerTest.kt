...
class SyncWorkerTest {
    ...
    @Test
    fun `a successful sync reports success`() = runTest {
    ...
    @Test
    fun `a failed sync asks WorkManager to retry`() = runTest {
        val failing = object : PotholeRepository by FakePotholeRepository() {
